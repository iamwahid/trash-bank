...
@section('content')
{{ html()->modelForm($siswa, 'POST', route('admin.kasir.barang', $siswa->id))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            Kasir
                            <small class="text-muted">Tukar Barang</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                        {{ html()->label("Barang")->class('col-md-2 form-control-label')->for('barang') }}
                        ...
                        <div class="form-group row">
                        {{ html()->label("Total Point")->class('col-md-2 form-control-label')->for('total') }}
