    ...
    public function create(array $data)
    {
        return DB::transaction(function () use ($data) {
            $user = parent::create([
                ...
                'confirmed' => $data['confirmed'],// ! (config('access.users.requires_approval') || config('access.users.confirm_email')),
            ]);
    ...
    public function register(array $data)
    {
        return DB::transaction(function () use ($data) {
            ...
            $user = parent::create([
                ...
                // If users require approval or needs to confirm email
                'confirmed' => true,// ! (config('access.users.requires_approval') || config('access.users.confirm_email')),
                'confirm_agreement' => $data['confirm_agreement']
            ]);
